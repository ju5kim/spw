...
<script type="text/javascript">
		...
		$('#delGeneral').click(function(){
			...
			if(cbCnt==0){
				...
				if(pick==true){
					...
					document.myPageForm.action="/spw/myGeneralDel.spw?gnum="+gnum+"&gsort="+gsort;
	...
	function searchDate(){
		...
		console.log("to :: "+to);
		var sort = document.getElementById("gsort").value;
		console.log("sort :: "+sort);
		var qStr = "gsort="+sort+"&dateFrom="+from+"&dateTo="+to;
		console.log("qStr :: "+qStr);
		location.href="/spw/myGeneral.spw?"+qStr;
	}
	// 체크 박스 1개 선택.
...
%>
				<li class="grid_item">
					<a href="/spw/generalDetailForm.spw?gnum=<%=mgvo.getGnum()%>">
...
<%}%>
								...
								<img src="/spw/editImages/Thumb_<%=mgvo.getGphoto() %>">
							</div>
...
%>
		...
		<div class="list_paging paging_saja">
			...
			<jsp:param name="url" value="/spw/myGeneral.spw"/>
