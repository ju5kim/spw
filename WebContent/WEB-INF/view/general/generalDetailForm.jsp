...
<script type="text/javascript">
	$(document).ready(function(){
	    ...
	    $('#pick').click(function(){
	    	//alert("찜하기");
	    	var mnum = "<%=sessionNum%>";
	    	if(mnum!=null&&mnum.length>4){ //문자열 null 이라서 4라서
	    		var gnum = $("#gnum").val();
...
<%
			if(gsort.equals("1")){
%>
				<div class="product_sort_label label_saja">사자</div>
<%
			}else{
%>
				<div class="product_sort_label label_panda">판다</div>
<%
			}
%>
...
%>
				...
				<a href="/spw/deleteOK.spw" class="sitebtn">삭제</a>
